...
patchwork1 <- (figs[[1]] + figs[[3]]) / figs[[2]] + plot_layout(heights = c(1.2,0.8))

patchwork2 <-  figs[[4]] / (plot_spacer() + figs[[5]] + plot_spacer()) / figs[[6]] + plot_layout(heights = unit(c(), c('cm', 'null')))
...
# Supplement 1 (Code used to generate Figure 1 - R Visulaizations)
