...
CCCC
"
patchwork1 <- (((figs[[1]] + figs[[3]]) + plot_layout(widths  = c(0.8,1))) / figs[[2]])  + plot_layout(heights = c(1,0.5)) 
patchwork1

patchwork2 <-  (figs[[4]] / figs[[5]] / figs[[6]]) + plot_layout(design = layoutA, widths = c(0.2,1,0.2))

(patchwork1 | patchwork2) + plot_layout(widths = c(1,0.6))
